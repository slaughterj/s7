...
/* -------- isalnum -------- */
static s7_pointer s7_dl_isalnum(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isalnum_0;
  arg = args;
...
static s7_int isalnum_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isalnum(x));}
static s7_if_t isalnum_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isalnum_if_i); return(NULL);}


/* -------- isalpha -------- */
static s7_pointer s7_dl_isalpha(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isalpha_0;
  arg = args;
...
static s7_int isalpha_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isalpha(x));}
static s7_if_t isalpha_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isalpha_if_i); return(NULL);}


/* -------- iscntrl -------- */
static s7_pointer s7_dl_iscntrl(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_iscntrl_0;
  arg = args;
...
static s7_int iscntrl_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(iscntrl(x));}
static s7_if_t iscntrl_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(iscntrl_if_i); return(NULL);}


/* -------- isdigit -------- */
static s7_pointer s7_dl_isdigit(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isdigit_0;
  arg = args;
...
static s7_int isdigit_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isdigit(x));}
static s7_if_t isdigit_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isdigit_if_i); return(NULL);}


/* -------- islower -------- */
static s7_pointer s7_dl_islower(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_islower_0;
  arg = args;
...
static s7_int islower_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(islower(x));}
static s7_if_t islower_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(islower_if_i); return(NULL);}


/* -------- isgraph -------- */
static s7_pointer s7_dl_isgraph(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isgraph_0;
  arg = args;
...
static s7_int isgraph_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isgraph(x));}
static s7_if_t isgraph_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isgraph_if_i); return(NULL);}


/* -------- isprint -------- */
static s7_pointer s7_dl_isprint(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isprint_0;
  arg = args;
...
static s7_int isprint_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isprint(x));}
static s7_if_t isprint_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isprint_if_i); return(NULL);}


/* -------- ispunct -------- */
static s7_pointer s7_dl_ispunct(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_ispunct_0;
  arg = args;
...
static s7_int ispunct_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(ispunct(x));}
static s7_if_t ispunct_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(ispunct_if_i); return(NULL);}


/* -------- isspace -------- */
static s7_pointer s7_dl_isspace(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isspace_0;
  arg = args;
...
static s7_int isspace_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isspace(x));}
static s7_if_t isspace_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isspace_if_i); return(NULL);}


/* -------- isupper -------- */
static s7_pointer s7_dl_isupper(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isupper_0;
  arg = args;
...
static s7_int isupper_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isupper(x));}
static s7_if_t isupper_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isupper_if_i); return(NULL);}


/* -------- isxdigit -------- */
static s7_pointer s7_dl_isxdigit(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int isxdigit_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isxdigit(x));}
static s7_if_t isxdigit_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isxdigit_if_i); return(NULL);}


/* -------- tolower -------- */
static s7_pointer s7_dl_tolower(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_tolower_0;
  arg = args;
...
static s7_int tolower_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(tolower(x));}
static s7_if_t tolower_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(tolower_if_i); return(NULL);}


/* -------- toupper -------- */
static s7_pointer s7_dl_toupper(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_toupper_0;
  arg = args;
...
static s7_int toupper_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(toupper(x));}
static s7_if_t toupper_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(toupper_if_i); return(NULL);}
...
/* -------- feclearexcept -------- */
static s7_pointer s7_dl_feclearexcept(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int feclearexcept_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(feclearexcept(x));}
static s7_if_t feclearexcept_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(feclearexcept_if_i); return(NULL);}
...
static s7_pointer s7_dl_fegetexceptflag(s7_scheme *sc, s7_pointer args)
{
  ...
  arg = args;
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_fegetexceptflag_0 = (fexcept_t*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "fegetexceptflag", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
/* -------- feraiseexcept -------- */
static s7_pointer s7_dl_feraiseexcept(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int feraiseexcept_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(feraiseexcept(x));}
static s7_if_t feraiseexcept_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(feraiseexcept_if_i); return(NULL);}
...
static s7_pointer s7_dl_fesetexceptflag(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fesetexceptflag", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
/* -------- fetestexcept -------- */
static s7_pointer s7_dl_fetestexcept(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int fetestexcept_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(fetestexcept(x));}
static s7_if_t fetestexcept_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(fetestexcept_if_i); return(NULL);}
...
static s7_int fegetround_if_i(s7_scheme *sc, s7_pointer **p) {return(fegetround());}
static s7_if_t fegetround_if(s7_scheme *sc, s7_pointer expr) {return(fegetround_if_i);}


/* -------- fesetround -------- */
static s7_pointer s7_dl_fesetround(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int fesetround_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(fesetround(x));}
static s7_if_t fesetround_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(fesetround_if_i); return(NULL);}


/* -------- fegetenv -------- */
static s7_pointer s7_dl_fegetenv(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "fegetenv", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)fegetenv(s7_dl_fegetenv_0)));
}


/* -------- feholdexcept -------- */
static s7_pointer s7_dl_feholdexcept(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "feholdexcept", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)feholdexcept(s7_dl_feholdexcept_0)));
}


/* -------- fesetenv -------- */
static s7_pointer s7_dl_fesetenv(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "fesetenv", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)fesetenv(s7_dl_fesetenv_0)));
}


/* -------- feupdateenv -------- */
static s7_pointer s7_dl_feupdateenv(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "feupdateenv", 0, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_memcpy(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "memcpy", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_memcpy_1 = (void*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "memcpy", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
    s7_dl_memcpy_2 = (size_t)s7_integer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "memcpy", 3, s7_car(arg), "integer"));
  return(s7_make_c_pointer(sc, (void*)memcpy(s7_dl_memcpy_0, s7_dl_memcpy_1, s7_dl_memcpy_2)));
}
...
static s7_pointer s7_dl_memmove(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "memmove", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_memmove_1 = (void*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "memmove", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
    s7_dl_memmove_2 = (size_t)s7_integer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "memmove", 3, s7_car(arg), "integer"));
  return(s7_make_c_pointer(sc, (void*)memmove(s7_dl_memmove_0, s7_dl_memmove_1, s7_dl_memmove_2)));
}
...
static s7_pointer s7_dl_memset(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "memset", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
  ...
  return(s7_make_c_pointer(sc, (void*)memset(s7_dl_memset_0, s7_dl_memset_1, s7_dl_memset_2)));
}
...
static s7_pointer s7_dl_memcmp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "memcmp", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_memcmp_1 = (void*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "memcmp", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_memchr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "memchr", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
  ...
  return(s7_make_c_pointer(sc, (void*)memchr(s7_dl_memchr_0, s7_dl_memchr_1, s7_dl_memchr_2)));
}
...
/* -------- strlen -------- */
static s7_pointer s7_dl_strlen(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_strlen_0;
  arg = args;
...
/* -------- strerror -------- */
static s7_pointer s7_dl_strerror(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
/* -------- remove -------- */
static s7_pointer s7_dl_remove(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_remove_0;
  arg = args;
...
{
  return(s7_make_c_pointer(sc, (void*)tmpfile()));
}


/* -------- tmpnam -------- */
static s7_pointer s7_dl_tmpnam(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_tmpnam_0;
  arg = args;
  if (s7_is_string(s7_car(arg)))
    s7_dl_tmpnam_0 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "tmpnam", 0, s7_car(arg), "string"));
  return(s7_make_string(sc, (char*)tmpnam(s7_dl_tmpnam_0)));
}


/* -------- tempnam -------- */
static s7_pointer s7_dl_tempnam(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_tempnam_0;
  char* s7_dl_tempnam_1;
  arg = args;
  if (s7_is_string(s7_car(arg)))
    s7_dl_tempnam_0 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "tempnam", 1, s7_car(arg), "string"));
  arg = s7_cdr(arg);
  if (s7_is_string(s7_car(arg)))
    s7_dl_tempnam_1 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "tempnam", 2, s7_car(arg), "string"));
  return(s7_make_string(sc, (char*)tempnam(s7_dl_tempnam_0, s7_dl_tempnam_1)));
}


/* -------- fclose -------- */
static s7_pointer s7_dl_fclose(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_fclose_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "fclose", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)fclose(s7_dl_fclose_0)));
}


/* -------- fflush -------- */
static s7_pointer s7_dl_fflush(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_fflush_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "fflush", 0, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fopen(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)fopen(s7_dl_fopen_0, s7_dl_fopen_1)));
}
...
static s7_pointer s7_dl_freopen(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "freopen", 3, s7_car(arg), "c_pointer"));
  return(s7_make_c_pointer(sc, (void*)freopen(s7_dl_freopen_0, s7_dl_freopen_1, s7_dl_freopen_2)));
}
...
static s7_pointer s7_dl_fdopen(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)fdopen(s7_dl_fdopen_0, s7_dl_fdopen_1)));
}
...
static s7_pointer s7_dl_setbuf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "setbuf", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_string(s7_car(arg)))
...
static s7_pointer s7_dl_setvbuf(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "setvbuf", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_string(s7_car(arg)))
...
/* -------- setlinebuf -------- */
static s7_pointer s7_dl_setlinebuf(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "setlinebuf", 0, s7_car(arg), "c_pointer"));
...
/* -------- fgetc -------- */
static s7_pointer s7_dl_fgetc(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_fgetc_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "fgetc", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)fgetc(s7_dl_fgetc_0)));
}


/* -------- getc -------- */
static s7_pointer s7_dl_getc(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_getc_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "getc", 0, s7_car(arg), "c_pointer"));
...
static s7_int getchar_if_i(s7_scheme *sc, s7_pointer **p) {return(getchar());}
static s7_if_t getchar_if(s7_scheme *sc, s7_pointer expr) {return(getchar_if_i);}
...
static s7_pointer s7_dl_fputc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fputc", 2, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_putc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "putc", 2, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)putc(s7_dl_putc_0, s7_dl_putc_1)));
}


/* -------- putchar -------- */
static s7_pointer s7_dl_putchar(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_putchar_0;
  arg = args;
...
static s7_int putchar_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(putchar(x));}
static s7_if_t putchar_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(putchar_if_i); return(NULL);}
...
static s7_pointer s7_dl_fgets(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fgets", 3, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fputs(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fputs", 2, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)fputs(s7_dl_fputs_0, s7_dl_fputs_1)));
}


/* -------- puts -------- */
static s7_pointer s7_dl_puts(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_puts_0;
  arg = args;
...
static s7_pointer s7_dl_ungetc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "ungetc", 2, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fread(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fread", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
  ...
  else return(s7_wrong_type_arg_error(sc, "fread", 4, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fwrite(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fwrite", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
  ...
  else return(s7_wrong_type_arg_error(sc, "fwrite", 4, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fseek(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fseek", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
/* -------- ftell -------- */
static s7_pointer s7_dl_ftell(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_ftell_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "ftell", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)ftell(s7_dl_ftell_0)));
}


/* -------- rewind -------- */
static s7_pointer s7_dl_rewind(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_rewind_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "rewind", 0, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fgetpos(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fgetpos", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_fgetpos_1 = (fpos_t*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "fgetpos", 2, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_fsetpos(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "fsetpos", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_fsetpos_1 = (fpos_t*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "fsetpos", 2, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)fsetpos(s7_dl_fsetpos_0, s7_dl_fsetpos_1)));
}


/* -------- clearerr -------- */
static s7_pointer s7_dl_clearerr(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "clearerr", 0, s7_car(arg), "c_pointer"));
...
/* -------- feof -------- */
static s7_pointer s7_dl_feof(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_feof_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "feof", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)feof(s7_dl_feof_0)));
}


/* -------- ferror -------- */
static s7_pointer s7_dl_ferror(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_ferror_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "ferror", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)ferror(s7_dl_ferror_0)));
}


/* -------- perror -------- */
static s7_pointer s7_dl_perror(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_perror_0;
  arg = args;
...
/* -------- fileno -------- */
static s7_pointer s7_dl_fileno(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_fileno_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "fileno", 0, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_popen(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)popen(s7_dl_popen_0, s7_dl_popen_1)));
}


/* -------- pclose -------- */
static s7_pointer s7_dl_pclose(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  FILE* s7_dl_pclose_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "pclose", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)pclose(s7_dl_pclose_0)));
}


/* -------- ctermid -------- */
static s7_pointer s7_dl_ctermid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
/* -------- flockfile -------- */
static s7_pointer s7_dl_flockfile(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "flockfile", 0, s7_car(arg), "c_pointer"));
...
/* -------- ftrylockfile -------- */
static s7_pointer s7_dl_ftrylockfile(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "ftrylockfile", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)ftrylockfile(s7_dl_ftrylockfile_0)));
}


/* -------- funlockfile -------- */
static s7_pointer s7_dl_funlockfile(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "funlockfile", 0, s7_car(arg), "c_pointer"));
...
/* -------- atof -------- */
static s7_pointer s7_dl_atof(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_atof_0;
  arg = args;
...
/* -------- atoi -------- */
static s7_pointer s7_dl_atoi(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_atoi_0;
  arg = args;
...
/* -------- atol -------- */
static s7_pointer s7_dl_atol(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_atol_0;
  arg = args;
...
/* -------- atoll -------- */
static s7_pointer s7_dl_atoll(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_atoll_0;
  arg = args;
...
static s7_int random_if_i(s7_scheme *sc, s7_pointer **p) {return(random());}
static s7_if_t random_if(s7_scheme *sc, s7_pointer expr) {return(random_if_i);}


/* -------- srandom -------- */
static s7_pointer s7_dl_srandom(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_srandom_0;
  arg = args;
...
/* -------- setstate -------- */
static s7_pointer s7_dl_setstate(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int rand_if_i(s7_scheme *sc, s7_pointer **p) {return(rand());}
static s7_if_t rand_if(s7_scheme *sc, s7_pointer expr) {return(rand_if_i);}


/* -------- srand -------- */
static s7_pointer s7_dl_srand(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_srand_0;
  arg = args;
...
/* -------- malloc -------- */
static s7_pointer s7_dl_malloc(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)malloc(s7_dl_malloc_0)));
}
...
static s7_pointer s7_dl_calloc(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)calloc(s7_dl_calloc_0, s7_dl_calloc_1)));
}
...
static s7_pointer s7_dl_realloc(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "realloc", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
    s7_dl_realloc_1 = (size_t)s7_integer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "realloc", 2, s7_car(arg), "integer"));
  return(s7_make_c_pointer(sc, (void*)realloc(s7_dl_realloc_0, s7_dl_realloc_1)));
}


/* -------- free -------- */
static s7_pointer s7_dl_free(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  void* s7_dl_free_0;
  arg = args;
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_free_0 = (void*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "free", 0, s7_car(arg), "c_pointer"));
  free(s7_dl_free_0);
  return(s7_unspecified(sc));
}
...
/* -------- exit -------- */
static s7_pointer s7_dl_exit(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_exit_0;
  arg = args;
...
/* -------- getenv -------- */
static s7_pointer s7_dl_getenv(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_getenv_0;
  arg = args;
...
/* -------- putenv -------- */
static s7_pointer s7_dl_putenv(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_putenv_0;
  arg = args;
...
/* -------- unsetenv -------- */
static s7_pointer s7_dl_unsetenv(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
/* -------- mktemp -------- */
static s7_pointer s7_dl_mktemp(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_mktemp_0;
  arg = args;
  if (s7_is_string(s7_car(arg)))
    s7_dl_mktemp_0 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "mktemp", 0, s7_car(arg), "string"));
  return(s7_make_string(sc, (char*)mktemp(s7_dl_mktemp_0)));
}


/* -------- mkstemp -------- */
static s7_pointer s7_dl_mkstemp(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
/* -------- system -------- */
static s7_pointer s7_dl_system(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_system_0;
  arg = args;
...
/* -------- realpath -------- */
static s7_pointer s7_dl_realpath(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_realpath_0;
  char* s7_dl_realpath_1;
  arg = args;
  if (s7_is_string(s7_car(arg)))
    s7_dl_realpath_0 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "realpath", 1, s7_car(arg), "string"));
  arg = s7_cdr(arg);
  if (s7_is_string(s7_car(arg)))
    s7_dl_realpath_1 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "realpath", 2, s7_car(arg), "string"));
  return(s7_make_string(sc, (char*)realpath(s7_dl_realpath_0, s7_dl_realpath_1)));
}


/* -------- abs -------- */
static s7_pointer s7_dl_abs(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_abs_0;
  arg = args;
...
static s7_int abs_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(llabs(x));}
static s7_if_t abs_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(abs_if_i); return(NULL);}


/* -------- labs -------- */
static s7_pointer s7_dl_labs(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_labs_0;
  arg = args;
...
static s7_int labs_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(labs(x));}
static s7_if_t labs_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(labs_if_i); return(NULL);}
...
/* -------- close -------- */
static s7_pointer s7_dl_close(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_close_0;
  arg = args;
...
static s7_int close_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(close(x));}
static s7_if_t close_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(close_if_i); return(NULL);}
...
static s7_pointer s7_dl_read(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "read", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_write(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "write", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_pread(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "pread", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_pwrite(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "pwrite", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
/* -------- pipe -------- */
static s7_pointer s7_dl_pipe(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int* s7_dl_pipe_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "pipe", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)pipe(s7_dl_pipe_0)));
}


/* -------- alarm -------- */
static s7_pointer s7_dl_alarm(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_alarm_0;
  arg = args;
...
static s7_int alarm_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(alarm(x));}
static s7_if_t alarm_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(alarm_if_i); return(NULL);}


/* -------- sleep -------- */
static s7_pointer s7_dl_sleep(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_sleep_0;
  arg = args;
...
static s7_int sleep_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(sleep(x));}
static s7_if_t sleep_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(sleep_if_i); return(NULL);}
...
static s7_int pause_if_i(s7_scheme *sc, s7_pointer **p) {return(pause());}
static s7_if_t pause_if(s7_scheme *sc, s7_pointer expr) {return(pause_if_i);}
...
/* -------- chdir -------- */
static s7_pointer s7_dl_chdir(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_chdir_0;
  arg = args;
...
/* -------- dup -------- */
static s7_pointer s7_dl_dup(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_dup_0;
  arg = args;
...
static s7_int dup_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(dup(x));}
static s7_if_t dup_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(dup_if_i); return(NULL);}
...
/* -------- _exit -------- */
static s7_pointer s7_dl__exit(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl__exit_0;
  arg = args;
...
/* -------- sysconf -------- */
static s7_pointer s7_dl_sysconf(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_sysconf_0;
  arg = args;
...
static s7_int sysconf_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(sysconf(x));}
static s7_if_t sysconf_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(sysconf_if_i); return(NULL);}
...
static s7_int getpid_if_i(s7_scheme *sc, s7_pointer **p) {return(getpid());}
static s7_if_t getpid_if(s7_scheme *sc, s7_pointer expr) {return(getpid_if_i);}
...
static s7_int getppid_if_i(s7_scheme *sc, s7_pointer **p) {return(getppid());}
static s7_if_t getppid_if(s7_scheme *sc, s7_pointer expr) {return(getppid_if_i);}


/* -------- getpgid -------- */
static s7_pointer s7_dl_getpgid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_getpgid_0;
  arg = args;
...
static s7_int getpgid_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(getpgid(x));}
static s7_if_t getpgid_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(getpgid_if_i); return(NULL);}
...
static s7_int setsid_if_i(s7_scheme *sc, s7_pointer **p) {return(setsid());}
static s7_if_t setsid_if(s7_scheme *sc, s7_pointer expr) {return(setsid_if_i);}


/* -------- getsid -------- */
static s7_pointer s7_dl_getsid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_getsid_0;
  arg = args;
...
static s7_int getsid_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(getsid(x));}
static s7_if_t getsid_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(getsid_if_i); return(NULL);}
...
static s7_int getuid_if_i(s7_scheme *sc, s7_pointer **p) {return(getuid());}
static s7_if_t getuid_if(s7_scheme *sc, s7_pointer expr) {return(getuid_if_i);}
...
static s7_int geteuid_if_i(s7_scheme *sc, s7_pointer **p) {return(geteuid());}
static s7_if_t geteuid_if(s7_scheme *sc, s7_pointer expr) {return(geteuid_if_i);}
...
static s7_int getgid_if_i(s7_scheme *sc, s7_pointer **p) {return(getgid());}
static s7_if_t getgid_if(s7_scheme *sc, s7_pointer expr) {return(getgid_if_i);}
...
static s7_int getegid_if_i(s7_scheme *sc, s7_pointer **p) {return(getegid());}
static s7_if_t getegid_if(s7_scheme *sc, s7_pointer expr) {return(getegid_if_i);}


/* -------- setuid -------- */
static s7_pointer s7_dl_setuid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_setuid_0;
  arg = args;
...
static s7_int setuid_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(setuid(x));}
static s7_if_t setuid_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(setuid_if_i); return(NULL);}


/* -------- setgid -------- */
static s7_pointer s7_dl_setgid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_setgid_0;
  arg = args;
...
static s7_int setgid_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(setgid(x));}
static s7_if_t setgid_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(setgid_if_i); return(NULL);}
...
static s7_int fork_if_i(s7_scheme *sc, s7_pointer **p) {return(fork());}
static s7_if_t fork_if(s7_scheme *sc, s7_pointer expr) {return(fork_if_i);}


/* -------- ttyname -------- */
static s7_pointer s7_dl_ttyname(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_ttyname_0;
  arg = args;
...
/* -------- isatty -------- */
static s7_pointer s7_dl_isatty(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_isatty_0;
  arg = args;
...
static s7_int isatty_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(isatty(x));}
static s7_if_t isatty_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(isatty_if_i); return(NULL);}
...
/* -------- unlink -------- */
static s7_pointer s7_dl_unlink(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_unlink_0;
  arg = args;
...
/* -------- rmdir -------- */
static s7_pointer s7_dl_rmdir(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_rmdir_0;
  arg = args;
...
/* -------- tcgetpgrp -------- */
static s7_pointer s7_dl_tcgetpgrp(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_int tcgetpgrp_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(tcgetpgrp(x));}
static s7_if_t tcgetpgrp_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(tcgetpgrp_if_i); return(NULL);}
...
/* -------- opendir -------- */
static s7_pointer s7_dl_opendir(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)opendir(s7_dl_opendir_0)));
}


/* -------- closedir -------- */
static s7_pointer s7_dl_closedir(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "closedir", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)closedir(s7_dl_closedir_0)));
}


/* -------- rewinddir -------- */
static s7_pointer s7_dl_rewinddir(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "rewinddir", 0, s7_car(arg), "c_pointer"));
...
/* -------- read_dir -------- */
static s7_pointer s7_dl_read_dir(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "read_dir", 0, s7_car(arg), "c_pointer"));
...
static s7_int clock_if_i(s7_scheme *sc, s7_pointer **p) {return(clock());}
static s7_if_t clock_if(s7_scheme *sc, s7_pointer expr) {return(clock_if_i);}


/* -------- time -------- */
static s7_pointer s7_dl_time(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  time_t* s7_dl_time_0;
  arg = args;
  ...
  else return(s7_wrong_type_arg_error(sc, "time", 0, s7_car(arg), "c_pointer"));
...
/* -------- gmtime -------- */
static s7_pointer s7_dl_gmtime(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "gmtime", 0, s7_car(arg), "c_pointer"));
  return(s7_make_c_pointer(sc, (void*)gmtime(s7_dl_gmtime_0)));
}


/* -------- ctime -------- */
static s7_pointer s7_dl_ctime(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "ctime", 0, s7_car(arg), "c_pointer"));
  return(s7_make_string(sc, (char*)ctime(s7_dl_ctime_0)));
}


/* -------- localtime -------- */
static s7_pointer s7_dl_localtime(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "localtime", 0, s7_car(arg), "c_pointer"));
  return(s7_make_c_pointer(sc, (void*)localtime(s7_dl_localtime_0)));
}
...
/* -------- tcdrain -------- */
static s7_pointer s7_dl_tcdrain(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_tcdrain_0;
  arg = args;
...
static s7_int tcdrain_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(tcdrain(x));}
static s7_if_t tcdrain_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(tcdrain_if_i); return(NULL);}
...
/* -------- getgrgid -------- */
static s7_pointer s7_dl_getgrgid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_getgrgid_0;
  arg = args;
  if (s7_is_integer(s7_car(arg)))
    s7_dl_getgrgid_0 = (int)s7_integer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "getgrgid", 0, s7_car(arg), "integer"));
  return(s7_make_c_pointer(sc, (void*)getgrgid(s7_dl_getgrgid_0)));
}


/* -------- getgrnam -------- */
static s7_pointer s7_dl_getgrnam(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  char* s7_dl_getgrnam_0;
  arg = args;
  if (s7_is_string(s7_car(arg)))
    s7_dl_getgrnam_0 = (char*)s7_string(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "getgrnam", 0, s7_car(arg), "string"));
  return(s7_make_c_pointer(sc, (void*)getgrnam(s7_dl_getgrnam_0)));
}
...
{
  return(s7_make_c_pointer(sc, (void*)getpwent()));
}


/* -------- getpwuid -------- */
static s7_pointer s7_dl_getpwuid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)getpwuid(s7_dl_getpwuid_0)));
}


/* -------- getpwnam -------- */
static s7_pointer s7_dl_getpwnam(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)getpwnam(s7_dl_getpwnam_0)));
}
...
static s7_pointer s7_dl_wordexp(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "wordexp", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
/* -------- wordfree -------- */
static s7_pointer s7_dl_wordfree(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "wordfree", 0, s7_car(arg), "c_pointer"));
...
/* -------- globfree -------- */
static s7_pointer s7_dl_globfree(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "globfree", 0, s7_car(arg), "c_pointer"));
...
/* -------- raise -------- */
static s7_pointer s7_dl_raise(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_raise_0;
  arg = args;
...
static s7_int raise_if_i(s7_scheme *sc, s7_pointer **p){s7_if_t f; s7_int x; f = (s7_if_t)(**p); (*p)++; x = f(sc, p); return(raise(x));}
static s7_if_t raise_if(s7_scheme *sc, s7_pointer expr) {if (s7_arg_to_if(sc, s7_cadr(expr))) return(raise_if_i); return(NULL);}


/* -------- sigemptyset -------- */
static s7_pointer s7_dl_sigemptyset(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "sigemptyset", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)sigemptyset(s7_dl_sigemptyset_0)));
}


/* -------- sigfillset -------- */
static s7_pointer s7_dl_sigfillset(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "sigfillset", 0, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_sigaddset(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sigaddset", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_sigdelset(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sigdelset", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_sigismember(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sigismember", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_sigprocmask(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sigprocmask", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_sigprocmask_2 = (sigset_t*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "sigprocmask", 3, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)sigprocmask(s7_dl_sigprocmask_0, s7_dl_sigprocmask_1, s7_dl_sigprocmask_2)));
}


/* -------- sigsuspend -------- */
static s7_pointer s7_dl_sigsuspend(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "sigsuspend", 0, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)sigsuspend(s7_dl_sigsuspend_0)));
}


/* -------- sigpending -------- */
static s7_pointer s7_dl_sigpending(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "sigpending", 0, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_getrlimit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "getrlimit", 2, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_setrlimit(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "setrlimit", 2, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)setrlimit(s7_dl_setrlimit_0, s7_dl_setrlimit_1)));
}


/* -------- getrusage -------- */
static s7_pointer s7_dl_getrusage(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  int s7_dl_getrusage_0;
  void* s7_dl_getrusage_1;
  arg = args;
  if (s7_is_integer(s7_car(arg)))
    s7_dl_getrusage_0 = (int)s7_integer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "getrusage", 1, s7_car(arg), "integer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_getrusage_1 = (void*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "getrusage", 2, s7_car(arg), "c_pointer"));
  return(s7_make_integer(sc, (s7_int)getrusage(s7_dl_getrusage_0, s7_dl_getrusage_1)));
}


/* -------- sethostent -------- */
static s7_pointer s7_dl_sethostent(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
{
  return(s7_make_c_pointer(sc, (void*)gethostent()));
}


/* -------- setservent -------- */
static s7_pointer s7_dl_setservent(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
{
  return(s7_make_c_pointer(sc, (void*)getservent()));
}


/* -------- setprotoent -------- */
static s7_pointer s7_dl_setprotoent(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
{
  return(s7_make_c_pointer(sc, (void*)getprotoent()));
}


/* -------- setnetent -------- */
static s7_pointer s7_dl_setnetent(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
{
  return(s7_make_c_pointer(sc, (void*)getnetent()));
}
...
/* -------- gethostbyname -------- */
static s7_pointer s7_dl_gethostbyname(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)gethostbyname(s7_dl_gethostbyname_0)));
}
...
static s7_pointer s7_dl_gethostbyaddr(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "gethostbyaddr", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
  ...
  return(s7_make_c_pointer(sc, (void*)gethostbyaddr(s7_dl_gethostbyaddr_0, s7_dl_gethostbyaddr_1, s7_dl_gethostbyaddr_2)));
}


/* -------- getnetbyname -------- */
static s7_pointer s7_dl_getnetbyname(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)getnetbyname(s7_dl_getnetbyname_0)));
}
...
static s7_pointer s7_dl_getnetbyaddr(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)getnetbyaddr(s7_dl_getnetbyaddr_0, s7_dl_getnetbyaddr_1)));
}
...
static s7_pointer s7_dl_getservbyname(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)getservbyname(s7_dl_getservbyname_0, s7_dl_getservbyname_1)));
}
...
static s7_pointer s7_dl_getservbyport(s7_scheme *sc, s7_pointer args)
{
  ...
  return(s7_make_c_pointer(sc, (void*)getservbyport(s7_dl_getservbyport_0, s7_dl_getservbyport_1)));
}


/* -------- getprotobyname -------- */
static s7_pointer s7_dl_getprotobyname(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)getprotobyname(s7_dl_getprotobyname_0)));
}


/* -------- getprotobynumber -------- */
static s7_pointer s7_dl_getprotobynumber(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  return(s7_make_c_pointer(sc, (void*)getprotobynumber(s7_dl_getprotobynumber_0)));
}


/* -------- freeaddrinfo -------- */
static s7_pointer s7_dl_freeaddrinfo(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
  ...
  else return(s7_wrong_type_arg_error(sc, "freeaddrinfo", 0, s7_car(arg), "c_pointer"));
...
/* -------- gai_strerror -------- */
static s7_pointer s7_dl_gai_strerror(s7_scheme *sc, s7_pointer args)
{
  s7_pointer arg;
...
static s7_pointer s7_dl_bind(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "bind", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_connect(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "connect", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_send(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "send", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_recv(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "recv", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_sendto(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sendto", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
  ...
  else return(s7_wrong_type_arg_error(sc, "sendto", 5, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_sendmsg(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sendmsg", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
static s7_pointer s7_dl_recvmsg(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "recvmsg", 2, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
{
  s7_pointer cur_env;
  s7_pointer pcl_xxi, pl_xxxi, pcl_t, pcl_s, pl_st, pl_ts, pl_sssi, pl_ssi, pl_ssix, pl_ix, pl_ixi, pl_ixxi, pl_xis, pcl_ixsi, pl_ixiix, pl_xi, pcl_di, pl_iixiixi, pl_iisi, pl_iixi, pl_iix, pcl_x, pl_xt, pl_txs, pl_tx, pl_sx, pcl_xs, pl_xssx, pl_ds, pcl_i, pl_it, pl_ti, pl_isxi, pl_issi, pl_isi, pcl_is, pl_si, pl_isx, pl_sisi, pl_sis;
  {
  ...
  s7_define(sc, cur_env, s7_make_symbol(sc, "SIG_IGN"), s7_make_c_pointer(sc, (void*)SIG_IGN));
  s7_define(sc, cur_env, s7_make_symbol(sc, "SIG_DFL"), s7_make_c_pointer(sc, (void*)SIG_DFL));
  s7_define(sc, cur_env, s7_make_symbol(sc, "SIG_ERR"), s7_make_c_pointer(sc, (void*)SIG_ERR));
  ...
  s7_define(sc, cur_env, s7_make_symbol(sc, "stderr"), s7_make_c_pointer(sc, (void*)stderr));
  s7_define(sc, cur_env, s7_make_symbol(sc, "stdout"), s7_make_c_pointer(sc, (void*)stdout));
  s7_define(sc, cur_env, s7_make_symbol(sc, "stdin"), s7_make_c_pointer(sc, (void*)stdin));
  ...
  s7_define(sc, cur_env, s7_make_symbol(sc, "_PATH_SERVICES"), s7_make_integer(sc, (s7_int)_PATH_SERVICES));
#endif
#ifdef _PATH_PROTOCOLS
  s7_define(sc, cur_env, s7_make_symbol(sc, "_PATH_PROTOCOLS"), s7_make_integer(sc, (s7_int)_PATH_PROTOCOLS));
#endif
#ifdef _PATH_NSSWITCH_CONF
  s7_define(sc, cur_env, s7_make_symbol(sc, "_PATH_NSSWITCH_CONF"), s7_make_integer(sc, (s7_int)_PATH_NSSWITCH_CONF));
#endif
#ifdef _PATH_NETWORKS
  s7_define(sc, cur_env, s7_make_symbol(sc, "_PATH_NETWORKS"), s7_make_integer(sc, (s7_int)_PATH_NETWORKS));
#endif
#ifdef _PATH_HEQUIV_PATH_HOSTS
  s7_define(sc, cur_env, s7_make_symbol(sc, "_PATH_HEQUIV_PATH_HOSTS"), s7_make_integer(sc, (s7_int)_PATH_HEQUIV_PATH_HOSTS));
#endif
#ifdef SOCK_NONBLOCK
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "recv", s7_dl_recv, 4, 0, false, "int recv(int void* int int)", pl_iixi));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "send"),
            s7_make_typed_function(sc, "send", s7_dl_send, 4, 0, false, "int send(int void* int int)", pl_iixi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "getprotobyname", s7_dl_getprotobyname, 1, 0, false, "void* getprotobyname(char*)", pcl_xs));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "getnetbyaddr", s7_dl_getnetbyaddr, 2, 0, false, "void* getnetbyaddr(int int)", pl_xi));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "getnetbyname"),
            s7_make_typed_function(sc, "getnetbyname", s7_dl_getnetbyname, 1, 0, false, "void* getnetbyname(char*)", pcl_xs));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "gethostbyname", s7_dl_gethostbyname, 1, 0, false, "void* gethostbyname(char*)", pcl_xs));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "getrusage", s7_dl_getrusage, 2, 0, false, "int getrusage(int void*)", pl_iix));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "sigprocmask", s7_dl_sigprocmask, 3, 0, false, "int sigprocmask(int sigset_t* sigset_t*)", pl_iix));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "getpwnam", s7_dl_getpwnam, 1, 0, false, "void* getpwnam(char*)", pcl_xs));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "getgrnam", s7_dl_getgrnam, 1, 0, false, "void* getgrnam(char*)", pcl_xs));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "getgrgid"),
            s7_make_typed_function(sc, "getgrgid", s7_dl_getgrgid, 1, 0, false, "void* getgrgid(int)", pl_xi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "mknod", s7_dl_mknod, 3, 0, false, "int mknod(char* int int)", pl_isi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "opendir", s7_dl_opendir, 1, 0, false, "DIR* opendir(char*)", pcl_xs));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "rmdir", s7_dl_rmdir, 1, 0, false, "int rmdir(char*)", pcl_is));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "unlink"),
            s7_make_typed_function(sc, "unlink", s7_dl_unlink, 1, 0, false, "int unlink(char*)", pcl_is));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "chdir", s7_dl_chdir, 1, 0, false, "int chdir(char*)", pcl_is));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "chown"),
            s7_make_typed_function(sc, "chown", s7_dl_chown, 3, 0, false, "int chown(char* int int)", pl_isi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "pwrite", s7_dl_pwrite, 4, 0, false, "ssize_t pwrite(int void* size_t int)", pl_iixi));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "pread"),
            s7_make_typed_function(sc, "pread", s7_dl_pread, 4, 0, false, "ssize_t pread(int void* size_t int)", pl_iixi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "realpath", s7_dl_realpath, 2, 0, false, "char* realpath(char* char*)", pcl_s));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "system"),
            s7_make_typed_function(sc, "system", s7_dl_system, 1, 0, false, "int system(char*)", pcl_is));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "mkstemp"),
            s7_make_typed_function(sc, "mkstemp", s7_dl_mkstemp, 1, 0, false, "int mkstemp(char*)", pcl_is));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "mktemp"),
            s7_make_typed_function(sc, "mktemp", s7_dl_mktemp, 1, 0, false, "char* mktemp(char*)", pcl_s));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "unsetenv"),
            s7_make_typed_function(sc, "unsetenv", s7_dl_unsetenv, 1, 0, false, "int unsetenv(char*)", pcl_is));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "putenv", s7_dl_putenv, 1, 0, false, "int putenv(char*)", pcl_is));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "free", s7_dl_free, 1, 0, false, "void free(void*)", pl_tx));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "realloc"),
            s7_make_typed_function(sc, "realloc", s7_dl_realloc, 2, 0, false, "void* realloc(void* size_t)", pcl_xxi));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "calloc"),
            s7_make_typed_function(sc, "calloc", s7_dl_calloc, 2, 0, false, "void* calloc(size_t size_t)", pl_xi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "atoll", s7_dl_atoll, 1, 0, false, "int atoll(char*)", pcl_is));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "atol"),
            s7_make_typed_function(sc, "atol", s7_dl_atol, 1, 0, false, "int atol(char*)", pcl_is));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "atoi"),
            s7_make_typed_function(sc, "atoi", s7_dl_atoi, 1, 0, false, "int atoi(char*)", pcl_is));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "fsetpos", s7_dl_fsetpos, 2, 0, false, "int fsetpos(FILE* fpos_t*)", pl_ix));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "fgetpos"),
            s7_make_typed_function(sc, "fgetpos", s7_dl_fgetpos, 2, 0, false, "int fgetpos(FILE* fpos_t*)", pl_ix));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "fseek", s7_dl_fseek, 3, 0, false, "int fseek(FILE* int int)", pl_ixi));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "puts", s7_dl_puts, 1, 0, false, "int puts(char*)", pcl_is));
  ...
  s7_define(sc, cur_env,
            s7_make_symbol(sc, "tempnam"),
            s7_make_typed_function(sc, "tempnam", s7_dl_tempnam, 2, 0, false, "char* tempnam(char* char*)", pcl_s));

  s7_define(sc, cur_env,
            s7_make_symbol(sc, "tmpnam"),
            s7_make_typed_function(sc, "tmpnam", s7_dl_tmpnam, 1, 0, false, "char* tmpnam(char*)", pcl_s));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "remove", s7_dl_remove, 1, 0, false, "int remove(char*)", pcl_is));
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "strlen", s7_dl_strlen, 1, 0, false, "size_t strlen(char*)", pcl_is));
  ...
  s7_if_set_function(s7_name_to_value(sc, "raise"), raise_if);
  s7_if_set_function(s7_name_to_value(sc, "tcdrain"), tcdrain_if);
  s7_if_set_function(s7_name_to_value(sc, "clock"), clock_if);
  s7_if_set_function(s7_name_to_value(sc, "tcgetpgrp"), tcgetpgrp_if);
  s7_if_set_function(s7_name_to_value(sc, "isatty"), isatty_if);
  s7_if_set_function(s7_name_to_value(sc, "fork"), fork_if);
  s7_if_set_function(s7_name_to_value(sc, "setgid"), setgid_if);
  s7_if_set_function(s7_name_to_value(sc, "setuid"), setuid_if);
  s7_if_set_function(s7_name_to_value(sc, "getegid"), getegid_if);
  s7_if_set_function(s7_name_to_value(sc, "getgid"), getgid_if);
  s7_if_set_function(s7_name_to_value(sc, "geteuid"), geteuid_if);
  s7_if_set_function(s7_name_to_value(sc, "getuid"), getuid_if);
  s7_if_set_function(s7_name_to_value(sc, "getsid"), getsid_if);
  s7_if_set_function(s7_name_to_value(sc, "setsid"), setsid_if);
  s7_if_set_function(s7_name_to_value(sc, "getpgid"), getpgid_if);
  s7_if_set_function(s7_name_to_value(sc, "getppid"), getppid_if);
  s7_if_set_function(s7_name_to_value(sc, "getpid"), getpid_if);
  s7_if_set_function(s7_name_to_value(sc, "sysconf"), sysconf_if);
  s7_if_set_function(s7_name_to_value(sc, "dup"), dup_if);
  s7_if_set_function(s7_name_to_value(sc, "pause"), pause_if);
  s7_if_set_function(s7_name_to_value(sc, "sleep"), sleep_if);
  s7_if_set_function(s7_name_to_value(sc, "alarm"), alarm_if);
  s7_if_set_function(s7_name_to_value(sc, "close"), close_if);
  s7_if_set_function(s7_name_to_value(sc, "labs"), labs_if);
  s7_if_set_function(s7_name_to_value(sc, "abs"), abs_if);
  s7_if_set_function(s7_name_to_value(sc, "rand"), rand_if);
  s7_if_set_function(s7_name_to_value(sc, "random"), random_if);
  s7_if_set_function(s7_name_to_value(sc, "putchar"), putchar_if);
  s7_if_set_function(s7_name_to_value(sc, "getchar"), getchar_if);
  s7_if_set_function(s7_name_to_value(sc, "fesetround"), fesetround_if);
  s7_if_set_function(s7_name_to_value(sc, "fegetround"), fegetround_if);
  s7_if_set_function(s7_name_to_value(sc, "fetestexcept"), fetestexcept_if);
  s7_if_set_function(s7_name_to_value(sc, "feraiseexcept"), feraiseexcept_if);
  s7_if_set_function(s7_name_to_value(sc, "feclearexcept"), feclearexcept_if);
  s7_if_set_function(s7_name_to_value(sc, "toupper"), toupper_if);
  s7_if_set_function(s7_name_to_value(sc, "tolower"), tolower_if);
  s7_if_set_function(s7_name_to_value(sc, "isxdigit"), isxdigit_if);
  s7_if_set_function(s7_name_to_value(sc, "isupper"), isupper_if);
  s7_if_set_function(s7_name_to_value(sc, "isspace"), isspace_if);
  s7_if_set_function(s7_name_to_value(sc, "ispunct"), ispunct_if);
  s7_if_set_function(s7_name_to_value(sc, "isprint"), isprint_if);
  s7_if_set_function(s7_name_to_value(sc, "isgraph"), isgraph_if);
  s7_if_set_function(s7_name_to_value(sc, "islower"), islower_if);
  s7_if_set_function(s7_name_to_value(sc, "isdigit"), isdigit_if);
  s7_if_set_function(s7_name_to_value(sc, "iscntrl"), iscntrl_if);
  s7_if_set_function(s7_name_to_value(sc, "isalpha"), isalpha_if);
  s7_if_set_function(s7_name_to_value(sc, "isalnum"), isalnum_if);
}
